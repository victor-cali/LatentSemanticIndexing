...
public class LSI {
    ...
    public LSI(FreqMat raw_freqT){
        ...
        this.u_ = this.u.getSubMatrix(0, this.u.getRowDimension()-1, 0, 7);
        this.s_ = this.s.getSubMatrix(0, 7, 0, 7);
        this.v_ = this.v.getSubMatrix(0, 7, 0, this.v.getColumnDimension()-1);

        this.freqMatLSI = this.s.multiply(this.v);
    }
